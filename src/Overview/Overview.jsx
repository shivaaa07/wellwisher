...
const Overview = () => {
    ...
    const data = [
       { 
            ...
            images: "images/icons/7.png"
       },
       {
            title: "Just 2 mins from NIBM Road",
            images: "images/icons/road.png"
       },
       {
            title: "The Biggest Carpet Area of 825 Sq.ft.",
            images: "images/icons/area.png"
       }       
    ];
    ...
    const secondAmenities = [
        {
            ...
            images: "images/icons/hotel.png"
        },
        {
            title: "Attractive Interest free EMI",
            images: "images/icons/signing.png"
        },
        {
            title: "Covered car parking",
            images: "images/icons/car-parking.png"
        }
    ]
                ...
                <Row className="mt-5 mb-5">
                    ...
                    <Col lg={6} className="order1">
                        <div className="img-wrapper ">
                            <img src="images/overview.jpg" alt="Overview" className="d-none d-sm-block d-xs-block overImg"/>
                        </div>
                    </Col>
                </Row>
            </Container>
